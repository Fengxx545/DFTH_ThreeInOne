...
public class NumberPicker extends View {
    ...
    private void readAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTextColor = a.getColor(R.styleable.NumberPicker_textColor, getResources().getColor(R.color.colorRulerLine));
    ...
    private void initPaint() {
        ...
        mDividerLinePaint.setColor(getResources().getColor(R.color.colorRulerBorder));
